...
class CustomizationViewController: UIThemedTableViewController {
    ...
    var icons: [String] = ["Default", "Drawn"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            if indexPath.row == 0 {
                cell = NXTextFieldTableCell(title: L10n("Username"), hint: "Anonym", key: "LDEUsername", defaultValue: "Anonym")
            } else {
                cell = NXTextFieldTableCell(title: L10n("Hostname"), hint: "localhost", key: "LDEHostname", defaultValue: "localhost") { newValue in
...
"""))
                ...
                cell = PickerTableCell(options: options, title: L10n("Theme"), key: "LDETheme", defaultValue: 0)
                ...
                cell = StepperTableCell(title: L10n("Font Size"), key: "LDEFontSize", defaultValue: 12, minValue: 6, maxValue: 20)
                ...
                (cell as! ToggleTableCell).configure(title: L10n("Show Line Numbers"), key: "LDEShowLineNumbers", defaultValue: true) { newValue in
                    self.themePreviewCell!.switchTheme(theme: LDEThemeReader.shared.currentlySelectedTheme())
                }
            } else if indexPath.row == 4 {
                cell = tableView.dequeueReusableCell(withIdentifier: ToggleTableCell.reuseIdentifier, for: indexPath) as! ToggleTableCell
                (cell as! ToggleTableCell).configure(title: L10n("Show Spaces"), key: "LDEShowSpaces", defaultValue: true) { newValue in
                    self.themePreviewCell!.switchTheme(theme: LDEThemeReader.shared.currentlySelectedTheme())
                }
            } else if indexPath.row == 5 {
                cell = tableView.dequeueReusableCell(withIdentifier: ToggleTableCell.reuseIdentifier, for: indexPath) as! ToggleTableCell
                (cell as! ToggleTableCell).configure(title: L10n("Wrap Lines"), key: "LDEWrapLines", defaultValue: true) { newValue in
                    self.themePreviewCell!.switchTheme(theme: LDEThemeReader.shared.currentlySelectedTheme())
                }
            } else if indexPath.row == 6 {
                cell = tableView.dequeueReusableCell(withIdentifier: ToggleTableCell.reuseIdentifier, for: indexPath) as! ToggleTableCell
                (cell as! ToggleTableCell).configure(title: L10n("Show Line Breaks"), key: "LDEShowLineBreaks", defaultValue: true) { newValue in
                    self.themePreviewCell!.switchTheme(theme: LDEThemeReader.shared.currentlySelectedTheme())
                }
            } else {
                cell = tableView.dequeueReusableCell(withIdentifier: ToggleTableCell.reuseIdentifier, for: indexPath) as! ToggleTableCell
                (cell as! ToggleTableCell).configure(title: L10n("Autoindent"), key: "LDEAutoindent", defaultValue: true)
            }
        } else {
